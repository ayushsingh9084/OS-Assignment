/*Q37. Consider the following four processes, with the length of the CPU burst given in milliseconds 
-------------------------------------
...
P4             3                     5
-------------------------------------
Write a C program to calculate average waiting time using shortest-remaining-time-first scheduling.
*/
#include<stdio.h>
#include<windows.h>
